...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/FrontEnd/codementor-officehours/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/FrontEnd/codementor-officehours/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _indian_cities = __webpack_require__(255);
	
	var _indian_cities2 = _interopRequireDefault(_indian_cities);
	...
	var Root = exports.Root = function (_React$Component) {
		...
		function Root() {
			...
			return (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(Root)).call.apply(_Object$getPrototypeO, [this].concat(args)));
		}
	
		(0, _createClass3.default)(Root, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(_App2.default, { list: _indian_cities2.default });
			}
		}]);
		return Root;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/FrontEnd/codementor-officehours/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  var ReactInvalidSetStateWarningDevTool = __webpack_require__(110);
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(111);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(253);
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'container' },
								_react2.default.createElement('input', { placeholder: 'Search...', className: 'input', type: 'text',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'container' },
								_react2.default.createElement(_Pagination2.default, { onClick: function onClick() {
										return _this2.handlePageChange.apply(_this2, arguments);
									}, pages: pages })
							)
						),
						_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
		...
		(0, _createClass3.default)(ListView, [{
			...
			value: function render() {
				...
				if (!list.length) {
					return _react2.default.createElement(
						"div",
						{ className: "list-view no-results" },
						"No Results"
					);
				}
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/FrontEnd/codementor-officehours/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ListView.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search = exports.search = function search(arr, query) {
		return arr.filter(function (i) {
			return i.toLowerCase().includes(query.toLowerCase());
		});
	};
	
	var paginate = exports.paginate = function paginate(_ref) {
		var total_count = _ref.total_count;
		var page = _ref.page;
		var page_size = _ref.page_size;
	
		var next_page = void 0,
		    prev_page = void 0;
		var max_pages = Math.ceil(total_count / page_size) - 1;
		next_page = page + 1;
		prev_page = page - 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pagination = function (_React$Component) {
		...
		(0, _createClass3.default)(Pagination, [{
			...
			value: function render() {
				...
				var next_page = pages.next_page;
				var page = pages.page;
				var prev_page = pages.prev_page;
	
				var nextPageButton = next_page >= 0 ? _react2.default.createElement(
					"li",
					{ onClick: function onClick() {
							return _onClick(next_page);
						} },
					next_page
				) : _react2.default.createElement("span", null);
				var prevPageButton = prev_page >= 0 ? _react2.default.createElement(
					"li",
					{ onClick: function onClick() {
							return _onClick(prev_page);
						} },
					prev_page
				) : _react2.default.createElement("span", null);
				var currentPageButton = _react2.default.createElement(
					"li",
					{ onClick: function onClick() {
	...
	Pagination.propTypes = {
		pages: _react2.default.PropTypes.any.isRequired,
